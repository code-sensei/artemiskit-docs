...
<CardGrid>
  ...
  <Card title="API (@artemiskit/core)" icon="puzzle">
    For embedding evaluations in your own code, test frameworks (Jest, Vitest), or custom tooling. SDK coming in v0.3.0.
...
- [API Documentation](/docs/api/) — Programmatic SDK (coming in v0.3.0)

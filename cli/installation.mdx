...
- [Getting Started](/docs/getting-started/) — Run your first evaluation
- [Scenarios](/docs/concepts/scenarios/) — Learn the scenario format
- [CLI Commands](/docs/cli/commands/run/) — Command reference

...
## Step 7: Validate Before Running (Optional)

Before running scenarios, you can validate them for syntax errors:

```bash
akit validate hello-world.yaml
```

This checks for YAML syntax errors, schema violations, and semantic issues without calling the LLM.

## What's Next

- [Scenario Format](/docs/cli/scenarios/format/) — Full YAML schema reference
- [Expectations](/docs/cli/scenarios/expectations/) — All evaluator types
...
- [CI/CD Integration](/docs/cli/ci-cd/) — GitHub Actions, GitLab CI, JUnit export

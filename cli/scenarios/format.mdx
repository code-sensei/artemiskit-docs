...
1. **Keep tags lowercase** — Consistent casing prevents confusion
2. **Use hyphens for multi-word** — `user-auth` not `userAuth` or `user_auth`
3. **Limit tag count** — 3-5 tags per case is usually sufficient
4. **Document tag meanings** — Maintain a tag glossary for your team
5. **Review regularly** — Remove unused tags to prevent clutter
...
- [Validate Command](/docs/cli/commands/validate/) — Validate scenarios without running
- [Run Command](/docs/cli/commands/run/) — Execute scenarios
- [Red Team Command](/docs/cli/commands/redteam/) — Security testing with multi-turn attacks
